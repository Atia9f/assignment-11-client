...
const AvailableFoodsCard = ({ allFood }) => {
    const { _id, food_name, food_image, donator: { name, image }, food_quantity, pickup_location,
        expired_datetime,
    ...
    return (
        ...
        <div className="card card-compact bg-base-100 shadow-xl my-8">
            ...
            <div className="card-body">
                ...
                {/* Expired */}
                <p className="text-sm mt-2"><span className="font-bold">Expires on:</span> {new Date(
                    expired_datetime
                ).toLocaleString()}</p>
                {/* Additional Notes */}
